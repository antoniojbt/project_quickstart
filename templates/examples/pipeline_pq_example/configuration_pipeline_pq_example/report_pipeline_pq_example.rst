...
files with names 'another_df' and 'pandas_DF_from_INI'.

In this report I've only included some results from the mtcars dataset examples
and 'another_df' files. 

'another_df' and 'pandas_DF_from_INI' are dataframes from random variables that
...
To output tables as csv or tsv you can use::
   ...
   .. csv-table::
   :file: ../desc_stats_another_df.tsv
   :delim: tab
